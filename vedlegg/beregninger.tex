...
\Cref{fig:prosessnettverk} viser prosesskartene for dronesystemet og referansesystemet. Heltrukne piler viser produktstrømmer mellom prosessene; stiplete piler viser miljøintervensjoner (utslipp) til og fra naturen. Positiv diagonal i teknologimatrisa $\mathbf{A}$ tilsvarer en prosess sin egen output; negative off-diagonale elementer er input fra en annen prosess.
...
Heltrukne piler viser produktstrømmer; stiplete oransje piler viser
miljøintervensjoner. Grønne ellipser er naturlige innsatsmidler eller
-utslippsmottakere utenfor systemgrensen.}
