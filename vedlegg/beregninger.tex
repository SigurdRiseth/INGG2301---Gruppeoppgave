...
\begin{table}[ht]
    ...
    \begin{tabular}{p{5.5cm} r l p{4.5cm}}
        ...
        \addlinespace
        Dagens praksis – driftskontroll  & 1      & per år    & Bane NOR, \parencite{app:kontaktlogg} \\
        Dagens praksis – ingeniørkontroll & 1/6   & per år    & Bane NOR (hvert 6. år), \parencite{app:kontaktlogg} \\
        \bottomrule
    \end{tabular}
\end{table}
