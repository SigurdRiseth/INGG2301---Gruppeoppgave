...
Dagens tilstandskontroll er i stor grad basert på periodiske, manuelle inspeksjoner utført av personell, supplert med operatørstyrte droner i vanskelig tilgjengelige områder \parencite{johannesen_bane_2021}. Disse metodene er ressurskrevende, avhengige av personelltilgjengelighet og innebærer fysisk tilstedeværelse i og nær sporet -- et risikofylt arbeidsmiljø. Planlagte, periodiske inspeksjoner gir dessuten begrenset innsikt i den løpende tilstandsutviklingen: skader som oppstår mellom befaringene kan forbli uoppdaget frem til neste planlagte gjennomgang.

Problemet kan dekomponeres i tre delproblem:

\begin{enumerate}
    \item \textbf{Lav inspeksjonsfrekvens.} Periodiske befaringer kan ikke fange opp tilstandsforringelse som oppstår mellom planlagte gjennomganger.
    \item \textbf{Personellrisiko.} Manuell inspeksjon i og nær spor og på høye broer medfører HMS-risiko for inspeksjonspersonell.
    \item \textbf{Reaktivt vedlikehold.} Mangel på kontinuerlige tilstandsdata gjør det vanskelig å drive prediktivt vedlikehold; tiltak iverksettes typisk reaktivt etter at avvik allerede har oppstått.
\end{enumerate}

Denne forståelsen av problemet er bekreftet gjennom innledende dialog med fagpersoner med tilknytning til norsk jernbanevirksomhet, som peker på at manglende kontinuerlig tilstandsdata er en av de største barrierene for å gå fra reaktivt til prediktivt vedlikehold.
...
Konseptet har tydelige paralleller til pågående initiativ internasjonalt. I Spania har luftfartsmyndigheten AESA gitt selskapet Ineco tillatelse til å benytte autonome droner i dokkingstasjoner til jernbaneinspeksjon \parencite{railwaygazette_spain_2024}. Den internasjonale jernbaneunionen (UIC) driver prosjektet Drone4Rail, som i samarbeid med EASA utvikler et regulatorisk rammeverk for langdistanse BVLOS-inspeksjon av jernbane \parencite{uic_drone4rail_2024}. EU-prosjektet RADIUS (Railway Digitalisation Using Drones) har videre utarbeidet konsepter for droneintegrerte dokkingstasjoner og trafikkstyring \parencite{euspa_radius_2024}. Disse initiativene bekrefter at det teknologiske og regulatoriske grunnlaget for konseptet er i ferd med å modnes internasjonalt, og at norsk jernbane har muligheten til å posisjonere seg tidlig i en fremvoksende markedsstruktur.
...
\begin{enumerate}
    ...
    \item \textbf{Betalingsvilje.} Kunden vil kjøpe løsningen fordi den reduserer kostnader knyttet til reaktivt vedlikehold og driftsavbrudd, forbedrer HMS for inspeksjonspersonell og gir et bedre og mer kontinuerlig beslutningsgrunnlag for prioritering av vedlikeholdstiltak.
...
\begin{table}[ht]
    ...
    \begin{tabular}{p{2cm}p{5cm}p{5cm}}
        ...
        \addlinespace
        Miljømessige &
        Erstatter fossildrevne inspeksjonskjøretøy og helikopter;
