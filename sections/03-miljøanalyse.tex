...
Til sammenlikning gir Bane NORs faktiske praksis — én driftskontroll per år og ingeniørkontroll hvert 6. år \parencite{app:kontaktlogg} — kun om lag 20\,kg~\ce{CO2eq}/år per bro. Det absolutte utslippet fra dronesystemet er dermed høyere enn dagens minimale inspeksjonsnivå, men dette reflekterer at dagens praksis leverer vesentlig lavere overvåkingsdekning. Dronesystemets miljøgevinst realiseres fullt ut når hyppig, kontinuerlig overvåking er målet.

Norges jernbanenett har over 2\,700 broer \parencite{jernbanedirektoratet_tall}; innføres systemet ved 500 kritiske objekter, tilsvarer besparelsen sammenlignet med tilsvarende manuell inspeksjonsfrekvens omlag $500 \times 796\,\text{kg} \approx 398\,\text{t}~\ce{CO2eq}/år$.
